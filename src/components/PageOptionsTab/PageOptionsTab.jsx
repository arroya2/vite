...
export default function PageOptionsTab() {
  ...
  return (
    <div className="flex-1 pl-2 font-secondary">
      ...
      <input
        className="block mb-3 p-2 rounded-lg"
        type="text"
        name="title"
        value={pageOptions.title}

export default function EducationWorkExperience({ options }) {
  ...
  function returnSchoolOrJob(array) {
    ...
    return (
      <div>
        ...
        <p className={`float-left font-secondary pb-3 text-[15px]`}>
          {' '}
          {array[1]}{' '}
        </p>
        <p className={`float-right font-secondary pb-3 text-[15px]`}>
          {' '}
          {dot} {array[2]}{' '}
        </p>
  ...
  return (
    <div className="w-full overflow-x-clip relative">
      <div
        className={`flex items-center top-0 w-[100%] h-[480px] bg-white text-black dark:bg-black dark:text-white`}
      >
        <div className={'p-20 grid grid-cols-2 gap-5 w-[100%] content-center'}>
          <div
            className={`pb-6 text-3xl whitespace-nowrap font-main text-transparent bg-clip-text w-[150px] bg-gradient-to-r ${gradient}`}
          >
            Education
          </div>
          <div
            className={`pb-6 text-3xl whitespace-nowrap font-main text-transparent bg-clip-text w-[250px] bg-gradient-to-r ${gradient}`}
          >
            Work Experience
          </div>
          {returnEntry()}
